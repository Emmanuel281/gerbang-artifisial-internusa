...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="relative h-screen overflow-hidden pt-[120px] md:pt-[130px] lg:pt-[160px] dark:bg-dark-2"
    >
      <div className="container h-full">
        <div className="-mx-4 flex h-full flex-wrap items-center">
          <div className="my-auto w-full px-4 ">
            <div
              className="hero-content wow fadeInUp m-auto w-full columns-2 place-items-center"
              data-wow-delay=".2s"
            >
              <div className="my-24">
              ...
              {/* <div>
                  <p className="mb-4 text-center text-base font-medium text-black/60 dark:text-white/60">
                    Play is now available for all popular blockchain
                  </p>
                  <div
